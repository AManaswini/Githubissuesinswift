...
class OpenIssueViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Open issues"
        GitHubClient.fetchIssues(state: "open"){ (issues, error) in
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Attribution: https://www.ralfebert.com/ios-examples/uikit/uitableviewcontroller/custom-cells/
        // Configure the cell...
        cell.title?.text = issuesGit[indexPath.row].title
        cell.issueImage?.image = UIImage(named: "mailbox.jpg")
